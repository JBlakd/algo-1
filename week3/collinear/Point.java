...
public class Point implements Comparable<Point> {
    ...
    // DEPRECATED
    // private double sqDistanceTo(Point that) {
    ...
    public static void main(String[] args) {
        ...
        assert (Math.abs(p1.slopeTo(p3) - (-1.5)) < epsilon);
        assert (Math.abs(p0.slopeTo(p2) - (2.0)) < epsilon);

        StdOut.println("Point.java main function no errors.");
    }
}
